...
|------|-------------|------|---------|:--------:|
| <a name="input_cluter_name"></a> [cluter\_name](#input\_cluter\_name) | EKS cluster name | `string` | n/a | yes |
| <a name="input_private_subnet_1a"></a> [private\_subnet\_1a](#input\_private\_subnet\_1a) | Subnet to create EKS cluster AZ 1a | `string` | n/a | yes |
| <a name="input_private_subnet_1b"></a> [private\_subnet\_1b](#input\_private\_subnet\_1b) | Subnet to create EKS cluster AZ 1b | `string` | n/a | yes |
